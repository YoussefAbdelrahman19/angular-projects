...
export class EditComponent implements OnInit {
  ...
  private initForm() {
    this.EmployeeForm = this.fb.group({
      ...
      empEmail: [null, [Validators.required, Validators.email, Validators.pattern("^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\\.[a-zA-Z]{3}$")]],
      empPhone:[null,[ Validators.required, Validators.pattern("01(0|1|2|5)[0-9]{8}$")]],
